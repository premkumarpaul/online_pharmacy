							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="text-grey-m2">
										...
										<div class="my-1">
											<em class="fa fa-phone fa-flip-horizontal text-secondary"></em>
											<strong class="text-600"><%=order.getPhoneNumber()%></strong>
										</div>
									</div>
								</div>
								...
								<div
									...
									<div class="text-grey-m2">
										...
										<div class="my-2">
											<em class="fa fa-circle text-blue-m2 text-xs mr-1"></em> <span
