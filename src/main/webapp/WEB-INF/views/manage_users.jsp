...
<%
	...
	<div class="d-flex justify-content-center container">
		<div class="class=col-lg-6 bg-indigo text-dark">
			<h3 class="class=col-lg-6 bg-indigo text-dark">Manage Users <a role="button" href="adduser"
										class="btn btn-outline-dark btn-lg ms-3 float-end">Add User</a></h3>
			<div class="card-body">
						 ...
						 <c:forEach items="${users}" var="user">
							<tr>
								...
								<a role="button" href="${pageContext.request.contextPath}/updateprofile?username=${user.username}"
										class="btn btn-outline-dark btn-sm ms-2">Edit</a>
									<a role="button" href="${pageContext.request.contextPath}/deleteuser?userId=${user.id}"
										class="btn btn-outline-dark btn-sm ms-2">Delete</a></td>
							</tr>
						</c:forEach>	
						</tbody>
					</table>
