...
<body>
	...
	<div class="d-flex justify-content-center container">
		...
		%>
		<h3 class="class=col-lg-6 bg-indigo text-dark"
					style="text-align: center; font-weight: bold;">Choose an
					option</h3>
			<div class="card-body">
				<a href="<%=request.getContextPath()%>/medicinerequest"
					role="button" class="btn btn-dark col-11 mt-4">View Medicine
					Requests</a><br></br>
				...
				<div class="row align-items-center g-3">
					...
					<div class="col-auto">
						<a href="/pdfConvert/<%=role%>"
							class="btn btn-dark text-center">Export all orders as PDF</a>
					</div>
				</div>
			</form>
			<br>
 ...
 %>
							...
							<h5 class="card-title text-primary">
								...
								if (token.contains("USER")) {
								%>
								<strong>Distributor Name: </strong><%=order.getDistributorName()%>
								<%
								} else {
								%>
							...
							<p class="card-text float-end mt-4">
								<strong class="text-dark">Distributor:</strong>&nbsp;
