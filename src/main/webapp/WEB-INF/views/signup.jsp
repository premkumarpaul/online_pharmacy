...
<style>
body{
  background-image: url('https://raoinformationtechnology.com/wp-content/uploads/2021/08/Developing-online-Pharmacy-App-Solutions.jpg');
		...
		<div class="d-flex justify-content-center">
			...
			<div class="col-lg-6 bg-indigo text-dark"
				...
				<div class="card-body">
						...
						<br>
						<button type="submit" class="btn btn-dark col-11 ms-3">Register</button>
